                            ...
                            <td class="text-end">
                                <div class="d-flex">
                                    <div class="dropdown ms-auto">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('orderDetails', ['id' => $row['orderId']]) }}" class="dropdown-item">show</a>
                                            <a href="{{ route('orderDetails', ['id' => $row['orderId']]) }}" class="dropdown-item">Edit</a>
